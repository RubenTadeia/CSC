...
public class CloudantController {
    ...
    private final String BASE_URL = "https://cscbruno.cloudant.com/";
     ...
     */
    public void readDoc(String database, String _id, final String tag, final ResponseListener listener) {
        StringRequest request = new StringRequest(mUrl + database + "/" + _id,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        if (listener != null) {
                            listener.onResponse(tag == null ? DOC_READ_TAG : tag, s);
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
     ...
     */
    public void createDoc(String database, String item, final String tag) throws JSONException {
     ...
     * @throws JSONException
     */
    public void updateDoc(String database,final String item, @NonNull String id,
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        if (mListener != null) {
                            mListener.onResponse(tag == null ? DOC_UPDATE_TAG : tag, item);
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
